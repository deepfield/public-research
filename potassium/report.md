...
- Registration packets containing the 19-byte fixed header `0a0b0c0d0e0f00030201020304050504030201`, a 1-byte plaintext tag length, an XOR-encoded body, and a 2-byte trailer (not strictly bound to a single checksum function — see [C2 protocol](#what-is-different-about-the-c2-protocol)).
